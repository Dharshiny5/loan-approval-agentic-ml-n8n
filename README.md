...
Python ML Layer
scikit-learn / XGBoostModels
Feature Engineering -pandas/NumPy
Model Results + Charts
GPT-4o NarrativeGeneration
reportlab PDF Report
Analyst Receives Report
Analyst Enters Loan ID
GPT-4o Decision Letter
Personalised Decision Letter
...
Loan-to-Income Ratio (0.2265)
Loan Term (0.1968)
Loan-to-Assets Ratio (0.0936)
